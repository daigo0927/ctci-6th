...
if __name__ == '__main__':
    ...
    num_paths1 = count_paths_with_sum(root1, 0)
    print(f'Tree1 contains {num_paths1} of with {0} summation')
    ...
    num_paths2 = count_paths_with_sum(root2, -14)
    print(f'Tree2 contains {num_paths2} of with {-14} summation')
    ...
    num_paths3 = count_paths_with_sum(root3, 0)
    num_paths4 = count_paths_with_sum(root3, 4)
    print(f'Tree3 contains {num_paths3} of with {0} summation')
    print(f'Tree3 contains {num_paths4} of with {4} summation')
